...
- **Heuristic Feedback Loop:** The app "learns" by keeping a rotating 7-day memory of its past picks, applying percentage gain/loss adjustments to the baseline scores.
