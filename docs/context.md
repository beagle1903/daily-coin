...
## Vision
To provide a fast, command-line tool that generates a daily cryptocurrency portfolio of 9 coins (6 volatile, 3 stable) using the Binance API, and features a heuristic feedback loop to "learn" from its previous picks.
